...
describe('web e2e: navigation & panes over a rich seeded session', () => {
  ...
  it.skipIf(MODE === 'record')('bash and file-path rows leave the workspace home occupant', async () => {
    ...
    // conversation details either — the expanded terminal card is read in place.
