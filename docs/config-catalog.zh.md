...
来源：[`packages/bundle/desktop-app/src/index.ts:26`](../packages/bundle/desktop-app/src/index.ts)
...
来源：[`packages/git/git-local/src/index.ts:19`](../packages/git/git-local/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-file`（[`packages/client/ui-file/src/index.ts`](../packages/client/ui-file/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-scm`（[`packages/client/ui-scm/src/index.ts`](../packages/client/ui-scm/src/index.ts)）
...
- `@deepseek-ai/dsh-git` — 抽象 `Git`（[`packages/git/git/src/index.ts`](../packages/git/git/src/index.ts)）
