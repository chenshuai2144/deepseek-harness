...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-scm ScmEntry id \'scm-open\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Source-control sidebar view.',
    doc: 'Source-control sidebar view. OCCUPIED by ui-scm. Opened from the agent\nsidebar foot, not an IDE activity bar.',
    registerOptions: [],
    ownerProps: [
      '/** Sidebar owner share: live column state from the frame\'s concession solve. */\nexport interface SidebarOwnerProps {\n  /** True when the sidebar is closed (the column renders the compact control rail). */\n  collapsed: boolean\n  /** Rendered column width in px (SIDEBAR_COLLAPSED when collapsed). */\n  width: number\n}',
    ],
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.scm\', () => ctx.slots.register(\n      { name: \'sidebar.scm\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
