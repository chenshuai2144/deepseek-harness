...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('git-not-a-repository'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  z.object({ code: z.literal('git-not-found'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  z.object({ code: z.literal('git-empty-message'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  z.object({ code: z.literal('git-failed'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  z.object({ code: z.literal('fs-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('fs-failed'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  z.object({ code: z.literal('fs-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fs-not-directory'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fs-not-text'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fs-not-regular-file'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fs-too-large'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fs-permission-denied'), message: z.string(), details: z.object({ path: z.string() }) }),
